...
2. 查看 [01_GenericWildcardDemo.java](./01_GenericWildcardDemo.java) 了解基本用法
3. 学习 [02_PECSPrincipleDemo.java](./02_PECSPrincipleDemo.java) 深入理解 PECS 原则
4. 通过 [03_GenericPitfallsDemo.java](./03_GenericPitfallsDemo.java) 了解泛型使用中的常见陷阱
5. 学习 [04_GenericRepositoryDemo.java](./04_GenericRepositoryDemo.java) 掌握泛型在实际项目中的应用
6. 最后阅读 [docs/02_GenericsUsageSummary.md](./docs/02_GenericsUsageSummary.md) 进行知识总结
